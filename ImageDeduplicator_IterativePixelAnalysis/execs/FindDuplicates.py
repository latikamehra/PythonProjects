...
class Find():
    ...
    def __init__(self, obj):
        ...
        self.confirmLevelCount = obj.confirmLevelCount
    ...
    def findDuplicates(self):
        ...
        probableDupeListList = ProbableDuplicates.fetch(self.potentialDupeListList, self.pixThreshold, self.confirmLevelCount)
